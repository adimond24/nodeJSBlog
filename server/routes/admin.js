...
//POST/register admin-resgister account
...
// get /add-post admin create new post
...
router.put("/edit-ost/:id", authMiddleware, async(req,res)=>{
    try{
        await Post.findByIdAndUpdate9(req.params.id,{
            title: req.body.title,
            body: req.body.body,
            updatedAt: Date.now(),
        });
